 ...
 */
public class EnrolledCoursesAdapter extends RecyclerView.Adapter<EnrolledCoursesAdapter.CoursesViewHolder> {
    private ArrayList<Course> mList;
    private Context mContext;
    private FragmentManager fragmentManager;


    public EnrolledCoursesAdapter(ArrayList<Course> mList, Context mContext, FragmentManager fragmentManager) {
        this.mList = mList;
